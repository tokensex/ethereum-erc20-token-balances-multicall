...
exports.getBalancesForEthereumAddresses = exports.getBalancesForEthereumAddress = void 0;
var bignumber_js_1 = __importDefault(require("bignumber.js"));
var ethereum_multicall_1 = require("ethereum-multicall");
var erc_20_abi_json_1 = __importDefault(require("./ABI/erc-20-abi.json"));
var BALANCE = 0;
var SYMBOL = 1;
var DECIMALS = 2;
var NAME = 3;
 ...
 */
function getBalancesForEthereumAddress(request) {
...
exports.getBalancesForEthereumAddress = getBalancesForEthereumAddress;
/**
 * Get balances for all users for all contracts in 1 single jsonrpc call
 * @param request The erc20 token balance request
 */
function getBalancesForEthereumAddresses(request) {
    return __awaiter(this, void 0, void 0, function () {
                ...
                case 0:
                    ...
                    for (i = 0; i < request.contractAddresses.length; i++) {
                        ...
                        for (u = 0; u < request.ethereumAddresses.length; u++) {
                            ...
                            contractCallContext.push(buildContractCallContext("".concat(token, "_").concat(ethereumAddress), ethereumAddress, token));
                        }
                    }
                    return [4 /*yield*/, multicall.call(contractCallContext)];
                case 1:
...
exports.getBalancesForEthereumAddresses = getBalancesForEthereumAddresses;
/**
 * Build the token
...
function buildToken(tokenInfo, formatBalances) {
    ...
    return {
        ...
        balance: formatBalances === true
            ? new bignumber_js_1.default(tokenInfo.callsReturnContext[BALANCE].returnValues[0].hex)
